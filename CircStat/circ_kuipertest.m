...
%   res       resolution at which the cdf is evaluated (number of
...
% CHANGES -
%   2011-06-09 CMDR
% 	take better care of providing defaults for missing or
% 	empty arguments on the call
...
if isempty(res), res=100; end;
if isempty(vis_on), vis_on=0; end;
