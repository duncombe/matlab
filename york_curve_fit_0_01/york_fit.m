...
% 
%YORK_FIT - performs linear regression for data with errors in both X and Y
% 
...
%between the errors.
% 
% a and b are slope and intercept respectively of the best fit line
% sigma_a and sigma_b are the std deviation of the slope and intercept
% b_save is vector of itermax b results 
%
%References:
