function y = maxfilt1(x,n,blksz,DIM)
%MAXFILT1  One dimensional median filter.
%	Y = MAXFILT1(X,N) returns the output of the order N, one dimensional
...
%	Processing Toolbox.
% 	See also MAXFILT! and MINFILT1 in the Useful Toolbox!
% 
