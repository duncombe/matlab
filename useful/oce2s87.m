function STP=oce2s87(fromfn,tofn,TCCPP,CRUISE,slope,intcpt,Nfilt,la,lo,dd,ddt)
% OCE2S87 -	Loads CTD data from oceansoft data file and outputs to S87 file
%
% USAGE -	oce2s87(fromfn,tofn,TCCPP,CRUISE,slope,intcpt,Nfilt,la,lo,dd,ddt) 
%
...
%
% load using ctpload
	[STP,stn,grid,sndg]=oceload(fromfn);
